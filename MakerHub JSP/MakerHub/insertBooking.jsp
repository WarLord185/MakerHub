...
<section>
    <form action="confirmBooking.jsp" method="post" class="form-box">
        <div class="form-value">
            <h2>Book a Space</h2>   
            <div class="inputbox">       
                <label for="r_id"><i class="fa fa-id-badge"></i> Renter ID </label>
                <input type="text" name="r_id" id="r_id" required>
            </div>
       
            <div class="inputbox">
                <label for="s_id"><i class="fa fa-archive icons"></i> Space ID </label>
            ...
            <div class="inputbox">
                <label for="b_date"><i class="fa fa-calendar icons"></i> Booking Date </label>
